                ...
                <div class="col-md-8">
                  ...
                  <div class="d-flex">
                    <div class="mr-auto">
                      ...
                      <h3 class="text-white mt-n1 mb-1">{{$this_week}}</h3>
                  ...
                  <div class="row">
                    <div class="col-6 col-lg-5">
                      ...
                      <div class="mt-1">
                        ...
                        <div class="font-weight-600 text-white">{{$store_earnings}}</div>
                      </div>
                    </div>
                    <div class="col-6 col-lg-5">
                      <div class="mt-1">
                      ...
                      <div class="mt-1">
                        ...
                        <div class="font-weight-600 text-white">{{$admin_earnings}}</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <hr class="hr-transparent bg-white-transparent-2 mt-3 mb-3" />
                   ...
                   <div class="mt-3 mb-2">
                    <a href="{{route('payout_req')}}" class="btn btn-yellow btn-rounded btn-sm pl-5 pr-5 pt-2 pb-2 fs-14px font-weight-600"><i class="fa fa-wallet mr-2 ml-n2"></i>{{ __('keywords.Go To Payout Section')}}</a>
                  </div>
                  <p class="fs-12px">
                    {{ __('keywords.It Takes You To Payout Section')}}.
                  </p>
                </div>
                <!-- END col-8 -->
