            ...
            <div class="row">
              ...
              <div class="col-xl-9">
               ...
               <div class="alert alert-success">
                ...
                <div id="general" class="mb-5">
                  <h4><i class="far fa-user fa-fw"></i> {{ __('keywords.Global Settings')}}</h4>
                  <p>{{ __('keywords.View and update your Global settings')}}.</p>
                       ...
                       @if(count($usernull)>0 && count($usernull1)>0)
                           ...
                           <div class="card">
                                    <div class="card-header card-header-primary">
                                      ...
                                      <p>{{ __('keywords.Generate Referral Codes For The Users Who Does Not Have Referral Codes')}}</p>
                ...
                <div id="sms" class="mb-5">
                  <h4><i class="far fa-bell fa-fw"></i> {{ __('keywords.OTP and SMS')}}</h4>
                  <p>{{ __('keywords.SMS and OTP settings')}}</p>
                  <div class="card">
                      <div class="card-header card-header-primary">
              ...
              <!-- BEGIN #app_settings -->
                <div id="appsettings" class="mb-5">
                  <h4><i class="far fa-copyright fa-fw"></i> {{ __('keywords.FCM Keys')}}</h4>
                  <p>fcm keys.</p>
                  <div class="col-md-12">
                                      <div class="card">
                                        <div class="card-header card-header-primary">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                               <div class="col-md-12">
                                                <div class="form-group">
                                                  <label class="bmd-label-floating">{{ __('keywords. App FCM Server Key')}}</label>
                ...
                <div id="payment" class="mb-5">
                  <h4><i class="far fa-credit-card fa-fw"></i> {{ __('keywords.Payment')}}</h4>
                  <p>{{ __('keywords.Manage your payment provider')}}</p>
           <div class="card">
                <div class="card-header card-header-primary">
            ...
            <div class="card-body">
              ...
              <h5 class="header-title">{{ __('keywords.Choose One') }} {{ __('keywords.Payment Gateways') }}</h5>
               ...
               <form method="post" class="appsvan-submit params-panel" autocomplete="off" action="{{route('gateway_status')}}" enctype="multipart/form-data">
                {{ csrf_field() }}   
                      ...
                      <select class="form-control" name="gateway" required>
                         ...
                         <option value="paypal" {{ get_option('paypal_active') == 'Yes' ? 'selected' : '' }}>{{ __('keywords.PayPal') }}</option>
               ...
               <form method="post" class="appsvan-submit params-panel" autocomplete="off" action="{{route('updategateway')}}" enctype="multipart/form-data">
                ...
                <h5 class="header-title">{{ __('keywords.PayPal') }}</h5>
                <div class="params-panel border border-dark p-3">
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                      <label class="control-label">{{ __('keywords.PayPal Active') }}</label>           
                      <select class="form-control" disabled>
                         <option value="Yes"  {{ get_option('paypal_active') == 'Yes' ? 'selected' : '' }}>{{ __('keywords.Yes') }}</option>
                         <option value="No"  {{ get_option('paypal_active') == 'No' ? 'selected' : '' }}>{{ __('keywords.No') }}</option>
                      </select>
                      </div>
                    </div>
                  ...
                  <div class="col-md-4">
                      <div class="form-group">
                      <label class="control-label">{{ __('keywords.Client ID') }}</label>           
                ...
                <div class="params-panel border border-dark p-3">
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                      <label class="control-label">{{ __('keywords.Key ID') }}</label>            
                ...
                <div id="map" class="mb-5">
                  <h4><i class="far fa-bell fa-fw"></i> {{ __('keywords.Map Settings')}}</h4>
                  <p>{{ __('keywords.Map Settings')}}</p>
                  <div class="card">
                    <div class="list-group list-group-flush">
                      <div class="list-group-item d-flex align-items-center">
                        <div class="flex-fill">
              ...
              <!-- BEGIN #Incentive -->
                <div id="incentive" class="mb-5">
                  <h4><i class="far fa-hdd fa-fw"></i> {{ __('keywords.Driver Incentive')}}  ({{$currency->currency_sign}})</h4>
                  <p>{{ __('keywords.Per Order')}}</p>
                  <div class="card">
                                    <div class="card-header card-header-primary">
                ...
                <div id="notice" class="mb-5">
                  <h4><i class="far fa-hdd fa-fw"></i> {{ __('keywords.App Notice')}}</h4>
                  <p>{{ __('keywords.App Notice')}}</p>
                  <div class="card">
                                    <div class="card-header card-header-primary">
                ...
                <div id="applink" class="mb-5">
                  <h4><i class="far fa-hdd fa-fw"></i> {{ __('keywords.App Links')}}</h4>
                  <p>{{ __('keywords.App Links')}}</p>
                  <div class="card">
                                    <div class="card-header card-header-primary">
                ...
                <div id="otherspace" class="mb-5">
                  <h4><i class="far fa-hdd fa-fw"></i> {{ __('keywords.Images Space')}}</h4>
                  <p>{{ __('keywords.Choose Images Space')}}</p>
                  <div class="card">
                                    <div class="card-header card-header-primary">
